...
struct AppHelper {
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.init(identifier: "org.cocoapods.migration")!.url(forResource: "SuaMusica", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("SuaMusica.sqlite")
