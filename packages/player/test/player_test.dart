...
void main() {
  ...
  group('Player operations', () {
    test(
      'Adding media to an empty queue shall make it the queue top',
      () async {
    ...
    test(
      'Rewind on a queue that was not played shall raise an error',
      () async {
        final subject = createPlayer();
        subject.enqueue(media: media1);
        subject.enqueue(media: media2);
    ...
    test(
      'Previous on a queue that was not played shall raise an error',
      () async {
        final subject = createPlayer();
        subject.enqueue(media: media1);
        subject.enqueue(media: media2);
    ...
    test(
      'Next on a queue that was not played shall start playing it',
      () async {
        final subject = createPlayer();
        subject.enqueue(media: media1);
        subject.enqueue(media: media2);
    ...
    test(
      'Top on an unplayed queue shall return the top of the queue',
      () async {
        final subject = createPlayer();
        subject.enqueue(media: media1);
        subject.enqueue(media: media2);
